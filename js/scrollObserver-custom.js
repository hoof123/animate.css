...
// targets
document.querySelectorAll('[data-as=customanimation_01]').forEach(element => {

    observercustomanimation_01.observe(element);
});

document.querySelectorAll('[data-as=customanimation_02]').forEach(element => {

    observercustomanimation_02.observe(element);
});

document.querySelectorAll('[data-as=customanimation_03]').forEach(element => {

    observercustomanimation_03.observe(element);
});

document.querySelectorAll('[data-as=customanimation_04]').forEach(element => {
